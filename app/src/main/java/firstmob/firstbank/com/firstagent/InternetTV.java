...
public class InternetTV extends Fragment implements View.OnClickListener {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.internettv, null);
        ...
        btnsub = (Button) root.findViewById(R.id.button5);
        ...
        if (view.getId() == R.id.button5) {
            new SweetAlertDialog(getActivity(), SweetAlertDialog.WARNING_TYPE)
                    ...
                    .setContentText("Are you sure you want to proceed with this transaction? \n \n" +
                            "Customer ID: 291212 \n  Amount : 5000 Naira \n Depositor Name: Test Customer \n Depositor Number : 0813333333  \n Narration: Monthl Internet   ")
