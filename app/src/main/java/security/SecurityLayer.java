...
Log("Imei is "+imei);
        ...
        return sb.append(ApplicationConstants.NET_URL +  endpoint)
...
String dehexcab = AESCBCEncryption.toString(pkey);
            ...
            Log.v("pkey_dehex",dehexcab);
            String pvokecab = AESCBCEncryption.toString(pvoke);
            Log.v("pvoke_cab",pvokecab);
...
String tken = newjs.optString("token");
        ...
        session.setString(KEY_APP_ID, nwappid);
    ...
    public static String genURLCBC(String params,String endpoint,  Context c) {
     ...
     //   String siv ="j3at/AyFvk4J7h32D+cECQ==";
      ...
      //  String appid = "113260437012100";
        ...
        String imei = Utility.getDevImei(c);
Log("Session Key",skey);
        ...
        return endpoint + "/" + encryptedUrl + "/" + hash + "/" + encryptedpkey + ApplicationConstants.CH_KEY + "/" + encappid + "/" + fnltkt + "/" + encryptedimei + "/" + fsess + "/" + vers + "/" + year;
